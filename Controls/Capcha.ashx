...
public class Capcha : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        objGraphics.DrawLine(RandomPen(autoRand.Next(0,26)), autoRand.Next(0, 95), autoRand.Next(0, 25), autoRand.Next(0, 95), autoRand.Next(0, 25));
        objGraphics.DrawLine(RandomPen(autoRand.Next(0, 26)), autoRand.Next(0, 95), autoRand.Next(0, 25), autoRand.Next(0, 95), autoRand.Next(0, 25));
        objGraphics.DrawLine(RandomPen(autoRand.Next(0, 26)), autoRand.Next(0, 95), autoRand.Next(0, 25), autoRand.Next(0, 95), autoRand.Next(0, 25));
        for (x = 0; x < digits; x++)
        {
        ...
        objGraphics.RotateTransform(-10 + autoRand.Next(0, 10));
        //This is to add the string to session cookie, to be compared later
        context.Session["capcha"] = randomStr;
        //' Set the content type and return the image
		//context.Response.Headers.Clear();
        context.Response.ContentType = "image/JPEG";
		//context.Response.Headers.Add("Expires", "Sat, 14 Mar 2010 00:02:48 GMT");
